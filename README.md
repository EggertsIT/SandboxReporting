...
- Destination domains are derived from the WEB `URL` host and reported in top-25
  ...
  highest block ratio.
- Timeline findings are grouped by UTC hour and include a clean thin-line
  ...
  with vertical day labels, and duration-axis ticks use human-friendly time
  ceilings instead of powers of ten.
